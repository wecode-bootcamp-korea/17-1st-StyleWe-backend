...
class OrderedProduct(models.Model):
    ...
    color_size_id       = models.ForeignKey('product.ColorSize', on_delete=models.PROTECT)
    status_id           = models.ForeignKey('Status', on_delete=models.PROTECT)
    order_id            = models.ForeignKey('Order', on_delete=models.SET_DEFAULT, default=FORBIDDEN)
    price               = models.DecimalField(max_digits=15, decimal_places=3)
